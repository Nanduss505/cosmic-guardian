...
function updateHUD() {
    ...
    let stageName = "Tahap 1 Siantanarus";
    if (level === 1) stageName = "Tahap 1 Siantanarus";
    else if (level === 2) stageName = "Tahap 2 Mukhsinius";
    else if (level === 3) stageName = "Tahap 3 Rengasinius";
...
function damagePlayer(playerObj) {
    ...
    // Ignore damage during victory fly-up transition
    if (typeof playerFlyingUp !== "undefined" && playerFlyingUp) {
        return;
    }
